...
public abstract class TabLayout extends HorizontalScrollView {
    ...
    private OnTouchListener mOnInterceptTouchEvent;

    public void setOnInterceptTouchEvent(OnTouchListener onInterceptTouchEvent) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        if (mOnInterceptTouchEvent != null) {
            mOnInterceptTouchEvent.onTouch(this, ev);
        }
...
//        }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        final void update() {
            ...
            final int customLayout = tab.getCustomViewLayout();
            if (custom != null || customLayout > 0) {
                if (custom != null) {
                    ...
                    custom = mCustomView = LayoutInflater.from(getContext())
                            .inflate(customLayout, this, false);
                    addView(mCustomView);
                }
                if (mTextView != null) {
